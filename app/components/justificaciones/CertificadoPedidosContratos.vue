...
const props = defineProps({
  ...
  pedido6Concepto: String,
  pedido6Proveedor: String,
  pedido6IdOferta: String,
  pedido6FechaOferta: String,
  pedido6ImporteOferta: String,
  pedido6IdPedido: String,
  pedido6FechaPedido: String,
  pedido6ImportePedido: String,
  pedido7Concepto: String,
  pedido7Proveedor: String,
  pedido7IdOferta: String,
  pedido7FechaOferta: String,
  pedido7ImporteOferta: String,
  pedido7IdPedido: String,
  pedido7FechaPedido: String,
  pedido7ImportePedido: String,
})
...
const pedidos = computed(() => [
  ...
  {
    concepto: props.pedido6Concepto,
    proveedor: props.pedido6Proveedor,
    idOferta: props.pedido6IdOferta,
    fechaOferta: props.pedido6FechaOferta,
    importeOferta: props.pedido6ImporteOferta,
    idPedido: props.pedido6IdPedido,
    fechaPedido: props.pedido6FechaPedido,
    importePedido: props.pedido6ImportePedido,
  },
  {
    concepto: props.pedido7Concepto,
    proveedor: props.pedido7Proveedor,
    idOferta: props.pedido7IdOferta,
    fechaOferta: props.pedido7FechaOferta,
    importeOferta: props.pedido7ImporteOferta,
    idPedido: props.pedido7IdPedido,
    fechaPedido: props.pedido7FechaPedido,
    importePedido: props.pedido7ImportePedido,
  },
])
</script>

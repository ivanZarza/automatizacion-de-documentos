...
.pagina-1 {
  background-image: url("/documentos-oficiales/justificaciones/formato-pago-justificacion-linea4-1.jpg");
}

.pagina-2 {
  background-image: url("/documentos-oficiales/justificaciones/formato-pago-justificacion-linea4-2.jpg");
}

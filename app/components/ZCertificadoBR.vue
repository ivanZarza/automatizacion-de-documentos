<template>
  <div class="print-wrapper" data-pdf-content>
    <article class="pagina-br">
      ...
      <section
        class="seccion bloque-registro"
        aria-label="Registro de la instalación"
      >
        ...
        <div class="registro-sello">
          <span
            >Sello oficial<br />Registro telemático de la Junta de
            Andalucía</span
          >
        </div>
      </section>
      ...
      <section class="seccion" aria-label="Titular de la instalación">
        ...
        <div class="grid-2">
          <div class="campo" data-field="titular_nombre">
          ...
          <div class="campo triple">
            ...
            <div class="subcampo" data-field="titular_email">
              Correo electrónico
            </div>
      ...
      <section class="seccion" aria-label="Datos de la instalación">
        ...
        <div class="grid-2 compacta">
          ...
          <div class="campo doble">
            <div class="subcampo" data-field="provincia_instalacion">
              Provincia
            </div>
            <div class="subcampo" data-field="cp_instalacion">
              Código Postal
            </div>
          </div>
        </div>
        ...
        <div class="grid-2 compacta">
          <div class="campo" data-field="tipo_edificacion">
            Tipo de instalación (3)
          </div>
          <div class="campo" data-field="superficie">Superficie (m²)</div>
        </div>

        <div class="campo" data-field="generador">
          G.3. Generadoras y convertidores: Producción de Energía Eléctrica
        </div>
      </section>
      ...
      <section class="seccion" aria-label="Características generales">
        ...
        <div class="bloque-caracteristicas">
          <div class="columna">
            <div class="campo" data-field="caja_general">
              Caja General de Protección - Intensidad Nominal (A)
            </div>
            <div class="campo" data-field="linea_general">
              Línea General de Alimentación
            </div>
            <div class="campo" data-field="potencia_prevista">
              Instalación - Potencia prevista (kW)
            </div>
            <div class="campo" data-field="derivacion_individual">
              Derivación individual - Potencia prevista (kW)
            </div>
          </div>

          <div class="columna">
            <div class="campo" data-field="conductor_lga">
              Conductor de la línea general de alimentación
            </div>
            <div class="campo" data-field="conductor_di">
              Conductor de la derivación individual
            </div>
            <div class="campo" data-field="protecciones">
              Protecciones instaladas / diferencial / magnetotérmico
            </div>
            <div class="campo" data-field="resistencia_tierra">
              Resistencia puesta a tierra (Ω)
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="seccion" aria-label="Verificación e inspección">
        ...
        <div class="grid-2 compacta">
          ...
          <div class="campo" data-field="colegio_num">
            Colegio Oficial / Nº Colegiado
          </div>
        </div>

        <div class="grid-2 compacta">
          <div class="campo" data-field="organismo_control">
            Organismo de Control Autorizado
          </div>
          <div class="campo" data-field="fecha_inspeccion">
            Referencia y fecha de inspección inicial favorable
          </div>
        </div>

        <div class="grid-2 compacta">
          <div class="campo" data-field="empresa_instaladora">
        ...
        <div class="grid-2 compacta">
          <div class="campo" data-field="instalador">
            Instalador en Baja Tensión
          </div>
          <div class="campo" data-field="nif_instalador">NIF / NIE / Otro</div>
        </div>

        <div class="campo observaciones" data-field="observaciones">
          Observaciones
        </div>
      </section>

      <section
        class="seccion clausula"
        aria-label="Cláusula de protección de datos"
      >
        <div class="barra-titulo">CLÁUSULA DE PROTECCIÓN DE DATOS</div>
        <div class="texto-legal">
          <p>
            Cumplimiento de lo dispuesto en el Reglamento General de Protección
            de Datos. Esta sección queda preparada para incluir el texto legal
            completo y las variables finales del documento.
          </p>
        </div>
      </section>

      <!-- overlays: etiquetas posicionadas por coordenadas -->
      <div
        v-for="f in fields"
        :key="f.name"
        class="overlay-field"
    ...
    <div class="editor-bar">
      <button @click.prevent="debug = !debug">
        {{ debug ? "Ocultar guías" : "Mostrar guías" }}
      </button>
    </div>
  </div>
</template>
...
// Config de campos (ejemplo inicial). Coordenadas en mm desde la esquina superior
// de la página (contenido de .pagina-br). Ajusta según necesites.
const fields = ref([
  {
    name: "registro_serie",
    label: "Serie",
...
// Datos de ejemplo para mostrar en la preview
const data = ref({
  registro_serie: "B",
  registro_numero: "12345",
  registro_digito: "26",
  expediente_bt: "",
  titular_nombre: "Nombre o Razón Social",
  titular_nif: "28.818.007-L",
});
...
.overlay-field.debug {
  outline: 0.8px dashed rgba(10, 38, 104, 0.5);

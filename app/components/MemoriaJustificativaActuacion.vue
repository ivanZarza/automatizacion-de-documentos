      ...
      <div class="contenedor-principal">
        ...
        <div class="seccion">
          ...
          <table class="tabla-costes">
            ...
            <tr>
              ...
              <td class="texto-rojo">{{ importeSinAmianto }}</td>
              <td class="texto-rojo">{{ importeSinAmiantoIva }}</td>
            </tr>
            <tr>
        ...
        <div class="seccion">
          ...
          <table class="tabla-acreditacion">
            <tr>
              <th>PORCENTAJE DE MEJORA ENERGÉTICA ACREDITADO</th>
            ...
            <tr>
              <th>IMPORTE DE LA SUBVENCIÓN RESULTANTE (MÁXIMO 18.800,00K)</th>
              <td class="valor-tabla">9.920,00 €</td>
            </tr>
          </table>
        </div>
        ...
        <div class="seccion">
          ...
          <div v-if="aerotermia" class="subseccion">
            ...
            <h4 class="titulo-subseccion">D3 HE 2 - CONDICIONES DE LAS INSTALACIONES TÉRMICAS.</h4>
            ...
            <ul class="lista-actividades">
              <li>El equipo instalado dispone de mercado CE, certificado <span class="texto-rojo">EJE</span> y etiquetado energético clase A, garantizando la eficiencia exigida</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="contenedor-principal">
        ...
        <div class="seccion">
          ...
          <div class="seccion-firma">
            <p style="margin-top: 40px;"><span class="etiqueta">Fecha:</span> <span class="texto-rojo">{{ fechaFirmaDia }} de {{ mesNombre }} de {{ fechaFirmaAnio }}</span></p>
...
defineProps({
  ...
  importeSinAmianto: { type: String, default: '' },
  importeSinAmiantoIva: { type: String, default: '' },
  importeTotalSinIva: { type: String, default: '' },
  importeTotalConIva: { type: String, default: '' },
  fechaFirmaDia: { type: String, default: '' },
  fechaFirmaMes: { type: String, default: '' },
  fechaFirmaAnio: { type: String, default: '' },

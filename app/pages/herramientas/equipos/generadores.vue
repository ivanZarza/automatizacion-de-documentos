...
const label = 'Generadores'
const icon = '🔧'
const campos = ['marca', 'modelo', 'potencia', 'especificacion']
const fieldsMapping = {
  marca: 'marcaEquipo',
  modelo: 'modeloEquipo',
  potencia: 'potenciaGenerador',
  especificacion: 'especificacionGenerador'
}

const equipos = computed(() => equipmentStore.generadores || [])
...
<template>
  <div class="pagina-equipos">
    <div class="header-content">
      ...
      <h1>{{ icon }} {{ label }}</h1>
      <p class="descripcion">Gestiona generadores para el formulario maestro</p>
    </div>
    ...
    <div v-else class="content">
      ...
      <div class="contenedor-equipos">
        ...
        <div v-if="equipos.length === 0" class="sin-equipos"><p>📭 No hay generadores registrados aún</p></div>

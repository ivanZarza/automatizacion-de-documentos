 ...
 */
  ...
  // ========== SECCIÓN: AUTORIZACIÓN COMUNICACIÓN PUESTA EN FUNCIONAMIENTO ==========
  // PÁGINA 1 - SECCIÓN 1: DATOS IDENTIFICATIVOS
  {
    name: 'apellidosNombreAutorizacion',
  ...
  {
    name: 'calidad',
    label: 'Actúa en Calidad de',
    placeholder: 'Seleccionar tipo...',
    type: 'select',
    options: ['Propietario', 'Instalador', 'Responsable técnico'],
    subsection: 'AUTORIZACIÓN'
  },

  // PÁGINA 1 - SECCIÓN 2: LUGAR Y MEDIO DE NOTIFICACIÓN
  {
    name: 'tipoVia',
    label: 'Tipo de Vía',
    placeholder: 'Seleccionar tipo...',
    type: 'select',
    options: ['Calle', 'Avenida', 'Plaza', 'Paseo', 'Camino', 'Carrera', 'Carretera'],
    subsection: 'AUTORIZACIÓN'
  },
  {
    name: 'nombreVia',
  ...
  {
    name: 'telefonoMovilAutorizacion',
  ...
  {
    name: 'correoElectronicoAutorizacion',
    label: 'Correo Electrónico',
    placeholder: 'Ej: ejemplo@correo.com',
    type: 'email',
    fullWidth: true,
  ...
  // PÁGINA 1 - SECCIÓN 3: DATOS DEL ESTABLECIMIENTO E INSTALACIONES
  {
    name: 'denominacionEstablecimiento',
    label: 'Denominación del Establecimiento',
    placeholder: 'Ej: Industria XYZ S.L.',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN'
  },
  {
    ...
    label: 'Domicilio',
    placeholder: 'Ej: Calle Industrial, 10',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN'
  },
  ...
  },
  {
    name: 'instalacion1',
    label: 'Instalación 1',
    placeholder: 'Descripción de la instalación 1',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN',
    optional: true
  },
  {
    name: 'instalacion2',
    label: 'Instalación 2',
    placeholder: 'Descripción de la instalación 2',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN',
    optional: true
  },
  {
    name: 'instalacion3',
    label: 'Instalación 3',
    placeholder: 'Descripción de la instalación 3',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN',
    optional: true
  },
  {
    name: 'instalacion4',
    label: 'Instalación 4',
    placeholder: 'Descripción de la instalación 4',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN',
    optional: true
  },
  {
    name: 'instalacion5',
    label: 'Instalación 5',
    placeholder: 'Descripción de la instalación 5',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN',
    optional: true
  },
  {
    name: 'instalacion6',
    label: 'Instalación 6',
    placeholder: 'Descripción de la instalación 6',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN',
    optional: true
  ...
  // PÁGINA 2 - SECCIÓN 4: DATOS DE LA PERSONA AUTORIZADA
  {
    name: 'figura',
    label: 'Figura',
    placeholder: 'Seleccionar figura...',
    type: 'select',
    options: ['Técnico competente', 'Instalador habilitado', 'Responsable técnico'],
    subsection: 'AUTORIZACIÓN'
  },
  {
    name: 'apellidosNombrePersona',
    label: 'Apellidos y Nombre',
    placeholder: 'Ej: González García, María',
    type: 'text',
    fullWidth: true,
    subsection: 'AUTORIZACIÓN'
  },
  ...
  // PÁGINA 2 - SECCIÓN 5: DECLARACIÓN, AUTORIZACIÓN, LUGAR, FECHA Y FIRMA
  {
    name: 'lugarFirma',
  ...
  {
    name: 'representante',
    label: 'Representante/Autorizado/Nombre',
  ...
  },
  {
    ...
    label: 'Código Directorio Común de Unidades Orgánicas y Oficinas',

...
export const memoriaTecnicaConfig = {
  ...
  fields: [
    ...
    // Sección G - Características de Líneas y Circuitos
    { name: 'potenciaGeneradorRegulador', label: 'Potencia Prevista - Generador a Regulador (kW)', placeholder: '', type: 'text' },
    { name: 'longitudGeneradorRegulador', label: 'Longitud - Generador a Regulador (m)', placeholder: '', type: 'text' },
    { name: 'materialGeneradorRegulador', label: 'Material/Sección - Generador a Regulador (mm²)', placeholder: '', type: 'text' },
    { name: 'intensidadGeneradorRegulador', label: 'Intensidad Admisible - Generador a Regulador (A)', placeholder: '', type: 'text' },
    { name: 'caidaTensionGeneradorRegulador', label: 'Caída Tensión - Generador a Regulador (%)', placeholder: '', type: 'text' },
    { name: 'potenciaReguladorBateria', label: 'Potencia Prevista - Regulador a Batería (kW)', placeholder: '', type: 'text' },
    { name: 'longitudReguladorBateria', label: 'Longitud - Regulador a Batería (m)', placeholder: '', type: 'text' },
    { name: 'materialReguladorBateria', label: 'Material/Sección - Regulador a Batería (mm²)', placeholder: '', type: 'text' },
    { name: 'intensidadReguladorBateria', label: 'Intensidad Admisible - Regulador a Batería (A)', placeholder: '', type: 'text' },
    { name: 'caidaTensionReguladorBateria', label: 'Caída Tensión - Regulador a Batería (%)', placeholder: '', type: 'text' },
    { name: 'potenciaSalidaRegulador', label: 'Potencia Prevista - Salida Regulador a Inversor (kW)', placeholder: '', type: 'text' },
    { name: 'longitudSalidaRegulador', label: 'Longitud - Salida Regulador a Inversor (m)', placeholder: '', type: 'text' },
    { name: 'materialSalidaRegulador', label: 'Material/Sección - Salida Regulador a Inversor (mm²)', placeholder: '', type: 'text' },
    { name: 'intensidadSalidaRegulador', label: 'Intensidad Admisible - Salida Regulador a Inversor (A)', placeholder: '', type: 'text' },
    { name: 'caidaTensionSalidaRegulador', label: 'Caída Tensión - Salida Regulador a Inversor (%)', placeholder: '', type: 'text' },

...
export const zDeclaracionTecnicoCompetenteConfig = {
  ...
  defaultData: {
    ...
    colegioFijo: 'COIIAOC',
    numeroColegiadoFijo: '4654',
    fraseFija1: 'Elaboracion de proyecto electrico de instalacion solar fotovoltaica de ___ kW',
    fraseFija2: 'Proyecto de ejecuccion de instalacion solar fotovoltaica de   ___        kW para autoconsumo en cubierta               ',
    provinciaSelect1: '',
    provinciaSelect2: '',
    nombreFirma: 'EDUARDO RIVERA CABEZAS',
    firma: '/firma-solay.png',

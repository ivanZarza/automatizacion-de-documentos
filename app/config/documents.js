...
export const certificadoPergolaAporticadaConfig = {
  ...
  fields: [
    ...
    { name: 'inclinacion', label: 'Inclinación de Paneles', type: 'text' },
  ...
  fieldMapping: {
    ...
    peso: 'peso',
    marcaModelo: 'e2_marcaModeloModulo',
    orientacion: 'e2_orientacionModulo',
    inclinacion: 'e2_inclinacionModulo',
...
export const memoriaTecnicaConfig = {
  ...
  defaultData: {
    ...
    marcaModeloInversor2: '',
    potenciaACInversor2: '',
    tensionNominalInversor2: '',
    vccMaximaInversor2: '',
    vccMinimaInversor2: '',
    tipoConexionInversor2: '',
    // E2.5 Baterías
    marcaModeloBateria: '',
    tipoBateria: '',
  ...
  fieldMapping: {
    ...
    vccMaximaInversor2: 'e2_formaOndaSalidaInversor2',
    vccMinimaInversor2: 'e2_frecuenciaNominalInversor2',
    tipoConexionInversor2: 'e2_tipoConexionRed2',
...
export const planosPlanosSituacionEmplazamientoCubiertaConfig = {
  ...
  fieldMapping: {
    ...
    pse_numero: (dataForm) => `${dataForm.numero ? dataForm.numero : ''} ${dataForm.bloque ? 'Bloque ' + dataForm.bloque : ''} ${dataForm.escalera ? 'Escalera ' + dataForm.escalera : ''} ${dataForm.planta ? 'Planta ' + dataForm.planta : ''} ${dataForm.puerta ? 'Puerta ' + dataForm.puerta : ''}`.trim(),

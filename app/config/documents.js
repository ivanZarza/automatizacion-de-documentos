...
export const zCertificadoBRConfig = {
  ...
  defaultData: {
    registro_instalacion: '123456',
    nombre: 'Ivan Zarza Estevez',
    nif: '12345678Z',
    domicilio: 'Ivan Zarza Estevez',
    cp: '28001',
    localidad: 'Calle de la hermosa portal 2 depto 3',
    provincia: 'Sevilla',
    correo_electronico: 'hxdfgghdfjfhjcxcvxcv',
    telefono: '1236547898',
    emplazamiento: 'Calle de la hermosa portal 2 depto 3',
    cups: '33444',
    instalacionTipo: 'modificacion',
    fase: 'monofasico',
    potenciaPrevista: '33444',
    Superficie: '33444',
    observaciones: 'Observaciones varias sobre la instalación',
    fecha: ''
  },
  fieldMapping: {

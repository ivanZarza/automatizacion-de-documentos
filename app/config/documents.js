...
export const zCertificadoBRConfig = {
  ...
  fields: [
    ...
    { name: 'proteccionesDiferenciales', label: 'Protecciones diferenciales', type: 'text' },
  ...
  fieldMapping: {
    ...
    cups: 'cups',
    instalacionTipo: 'instalacionTipo',
    ...
    proteccionesDiferenciales: 'proteccionesDiferenciales',

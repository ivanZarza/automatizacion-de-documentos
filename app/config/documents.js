...
export const zCertificadoDOACFVConfig = {
  ...
  fileName: 'certificado-direccion-obra-instalacion-equipos.pdf',
...
export const zDeclaracionDireccionObraConfig = {
  ...
  defaultData: {
    ...
    fraseFija1: 'Elaboracion de proyecto electricode instalacion solar fotovoltaica de    kW',
    fraseFija2: 'Proyecto de ejecuccion de instalacion solar fotovoltaica de   kW para autoconsumo en cubierta          ',
    provinciaSelect1:'',
    provinciaSelect2:''
  },
  fieldMapping: {
